  ...
  <div class="min-h-screen bg-base-100">
    <div class="container mx-auto px-4 md:px-8 py-8 max-w-4xl">
      ...
      <template v-else>
        <!-- 页面标题 -->
        <div class="mb-8">
          <h1 class="text-4xl font-bold mb-2">Edit Artist</h1>
          <p class="text-gray-600">Propose changes to artist information</p>
        </div>
...
onMounted(async () => {
  try {
    ...
    loadError.value = 'Failed to load artist data';
  } finally {
