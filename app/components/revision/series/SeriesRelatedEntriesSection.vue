<template>
  <div class="space-y-6">
    <div class="flex items-center gap-2">
      ...
      <div>
        <h2 class="text-lg font-semibold text-gray-900">关联条目</h2>
        <p class="text-sm text-gray-500">将系列关联到现有条目</p>
      </div>
    </div>

    <div class="border border-gray-200 rounded-lg p-4 space-y-3 bg-white">
      <div class="flex items-center justify-between">
        <h3 class="font-semibold text-gray-900">条目列表</h3>
      ...
      <div v-if="items.length === 0" class="text-sm text-gray-500">暂无关联条目。</div>
      <div
