<template>
  <section v-if="articles.length > 0" class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
    <!-- Header -->
    <div class="px-5 py-3 border-b border-gray-100 flex items-center gap-2.5">
      ...
      <span class="ml-auto text-xs text-gray-400">{{ articles.length }} 篇</span>
    </div>
